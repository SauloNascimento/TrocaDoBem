# -*- coding: utf-8 -*-
# Generated by Django 1.11.7 on 2017-12-02 14:49
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_deferred', models.CharField(choices=[('DEFERIDO', 'DEFERIDO'), ('EM ANÁLISE', 'EM ANÁLISE'), ('INDEFERIDO', 'INDEFERIDO')], max_length=100)),
                ('donor', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='donor', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(default='Nao Informado', max_length=30)),
                ('site', models.CharField(default='Nao Informado', max_length=30)),
                ('social', models.CharField(default='Nao Informado', max_length=30)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, unique=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('published_at', models.DateTimeField(auto_now=True)),
                ('status', models.CharField(choices=[('ACEITO', 'ACEITO'), ('EM ANÁLISE', 'EM ANÁLISE'), ('RECUSADO', 'RECUSADO')], max_length=100)),
        ...
        migrations.AddField(
            model_name='audit',
            name='new_owner',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='new_owner', to=settings.AUTH_USER_MODEL),
        ),
    ]
