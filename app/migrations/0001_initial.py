# -*- coding: utf-8 -*-
# Generated by Django 1.11.7 on 2018-01-31 02:44
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_deferred', models.CharField(choices=[('DEFERIDO', 'DEFERIDO'), ('EM ANÁLISE', 'EM ANÁLISE'), ('INDEFERIDO', 'INDEFERIDO')], default='EM ANÁLISE', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('published_at', models.DateTimeField(auto_now=True)),
                ('status', models.CharField(choices=[('ACEITO', 'ACEITO'), ('EM ANÁLISE', 'EM ANÁLISE'), ('RECUSADO', 'RECUSADO')], default='EM ANÁLISE', max_length=100)),
