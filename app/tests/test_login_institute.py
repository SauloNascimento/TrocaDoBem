...
class TestLoginInstitute(unittest.TestCase):
    def setUp(self):
    ...
    def test_login_institute(self):
        username = "institute-" + str(uuid.uuid4())
        driver = self.driver
        ...
        try:
            self.assertEqual("Troca do Bem", driver.find_element_by_css_selector("span.logo-lg").text)
        except AssertionError as e:
            self.verificationErrors.append(str(e))
