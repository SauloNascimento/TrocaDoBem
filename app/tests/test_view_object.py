...
class TestViewObject(unittest.TestCase):
    ...
    def test_view_object(self):
        ...
        driver.find_element_by_id("id_first_name").send_keys("Usuario " + str(uuid.uuid4()))
        ...
        try:
            self.assertEqual("Tipo de Objeto: Alimentos", driver.find_element_by_xpath("//div[4]").text)
        except AssertionError as e:
            self.verificationErrors.append(str(e))
        try:
            self.assertEqual("Item: Objeto Teste", driver.find_element_by_css_selector("div.form-group").text)
        except AssertionError as e:
            self.verificationErrors.append(str(e))
