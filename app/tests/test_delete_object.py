...
class TestEditObject(unittest.TestCase):
    ...
    def test_edit_object(self):
        ...
        driver.find_element_by_id("id_name_item").clear()
        driver.find_element_by_id("id_name_item").send_keys("ABCD New Object")
        Select(driver.find_element_by_id("id_object_type")).select_by_visible_text("Papelaria")
        driver.find_element_by_id("btn_salvar").click()
        try:
            self.assertEqual("ABCD New Object", driver.find_element_by_css_selector("h3.box-title").text)
        except AssertionError as e:
            self.verificationErrors.append(str(e))
        ...
        try:
            self.assertEqual("Objeto deletado com sucesso", driver.find_element_by_xpath("//div[3]/p").text)
        except AssertionError as e:
            self.verificationErrors.append(str(e))
        driver.find_element_by_css_selector("button.confirm").click()
